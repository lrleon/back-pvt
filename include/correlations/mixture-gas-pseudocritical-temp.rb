# coding: utf-8
declare_correlation_subtype("MixtureGasPseudocriticalTemperature",
              "GasCorrelation", "T_{pcM}");

################################################################

begin_correlation("TpcmKayMixingRule", "Rankine")
...
begin_correlation("AdjustedtpcmWichertAziz", "Rankine")
