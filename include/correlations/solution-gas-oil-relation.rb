...
begin_correlation("RsAlShammasi", "SCF_STB", 6, 3298.6)
...
begin_correlation("RsAlMarhoun", "SCF_STB", 26, 1602)
...
begin_correlation("RsDeGhetto", "SCF_STB", 17.21, 640.25)
...
begin_correlation("RsDindorukChristman", "SCF_STB")
...
begin_correlation("RsDoklaOsman", "SCF_STB")
...
begin_correlation("RsGlaso", "SCF_STB", 90, 2637)
...
begin_correlation("RsHanafy", "SCF_STB", 7, 4272)
...
begin_correlation("RsKartoatmodjoSchmidt", "SCF_STB", 0, 2890)
...
begin_correlation("RsLasater", "SCF_STB")
...
begin_correlation("RsPetroskyFarshad", "SCF_STB", 217, 1406)
...
begin_correlation("RsStanding", "SCF_STB", 20, 1425)
...
## verificada con python
begin_correlation("RsTotalCFPDetachedFromPb", "SCF_STB")
...
begin_correlation("RsTotalCFP", "SCF_STB")
add_title("TOTAL COMPAGNIE FRANÇAISE DES PÉTROLES (CFP) CORRELATION, CALCULATION OF SOLUTION GOR (FOR PRESSURES BELOW THE BUBBLE POINT)")
add_eq("R_s = \\gamma_g \\cdot \\left[ \\frac{P}{C_1} \\cdot 10 ^ {\\left( C_2 \\cdot \\gamma_{API} - C_3 \\cdot T \\right) } \\right] ^ {C_4}")
add_parameter("yg", "Sgg", "Gas specific gravity")
add_parameter("p", "psia", "Pressure")
...
## verificada con python
begin_correlation("RsVasquezBeggs", "SCF_STB", 0, 2199)
...
## verificada con python
begin_correlation("RsVelarde", "SCF_STB")
...
## verificada con python
begin_correlation("RsCegarra", "SCF_STB", 135, 4290)
...
## verificada con python
begin_correlation("RsPerezML", "SCF_STB", 38, 121)
...
## verificada con python
begin_correlation("RsMillanArcia", "SCF_STB", 53, 459)
...
## verificada con python
begin_correlation("RsManucciRosales", "SCF_STB", 180, 2500)
...
begin_correlation("RsLopezCR", "SCF_STB", 12, 110)
...
begin_correlation("RsSalazar", "SCF_STB", 26, 149)
...
begin_correlation("RsSalazarDetachedFromPb", "SCF_STB", 25, 154)
add_title("SALAZAR CORRELATION, CALCULATION OF SOLUTION GOR (FOR PRESSURES BELOW THE BUBBLE POINT)")
add_db("Based on 136 PVT reports from different areas of the Faja Petrolífera del Orinoco: 60 from Ayacucho, 48 from Junín, 26 from Carabobo, and 2 from Boyacá.")
