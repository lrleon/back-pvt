...
## verificada con python
begin_correlation("UodBeggsRobinson", "CP")
...
## verificada con python
begin_correlation("UodEgbogahNg", "CP")
...
## verificada con python
begin_correlation("UodGlaso", "CP", 0.2, 80)
...
## verificada con python
begin_correlation("UodKartoatmodjoSchmidt", "CP", 0.506, 682)
...
begin_correlation("UodSattarinEtAl", "CP", 2, 570)
...
## verificada con python
begin_correlation("UodNaseri", "CP", 0.75, 54)
...
## verificada con python
begin_correlation("UodPetroskyFarshad", "CP", 0.725, 10.249)
...
## verificada con python
begin_correlation("UodDeGhettoEtAl", "CP", 7.7, 1386.9)
...
## verificada con python
begin_correlation("UodPerezML", "CP")
...
begin_correlation("UodDindorukChristman", "CP", 0.896, 62.63)
