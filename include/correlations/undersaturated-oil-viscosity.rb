...
add_parameter("uobp", "CP", "Oil viscosity at Pb", 0.168, 184.86)
...
add_parameter("uobp", "CP", "Oil viscosity at Pb", 2.1, 295.9)
...
add_parameter("uobp", "CP", "Oil viscosity at Pb", 0.142, 127)
...
add_parameter("uobp", "CP", "Oil viscosity at Pb", 0.13, 17.9)
...
add_parameter("uobp", "CP", "Oil viscosity at Pb", 0.211, 3.546)
