...
add_db("Based on 71 natural gases from California, which represent surface trap gases and stock-tank vapors whose high gravity results from relatively high proportions of ethane, propane, and butanes. The correlation was developed with samples containing concentrations of nitrogen, carbon dioxide, and hydrogen sulfide, up to 5 mol %, 2 mol %, and 2 mol %, respectively.")
add_note("Standing (1977) presented two temperature correlations: one for \\\"condensate\\\" gases and one for \\\"California\\\" gases. Whitson & Brulé (2000) explained that the correlation for \\\"condensate\\\" gases applies to wet or high molecular weight gases, and the other one corresponds to dry hydrocarbon gases. Standing recommends using the \\\"California\\\" curves for surface gases.")
...
add_db("Based on laboratory generated gases in equilibrium with crude oil at high pressures (1000 to 8000 psia). Their high gravities come from relatively large quantities of heptanes and heavier compounds. The correlation was developed with samples containing concentrations of nitrogen, carbon dioxide, and hydrogen sulfide, up to 5 mol %, 2 mol %, and 2 mol %, respectively.")
add_note("Standing (1977) presented two temperature correlations: one for \\\"condensate\\\" gases and one for \\\"California\\\" gases. Whitson & Brulé (2000) explained that the correlation for \\\"condensate\\\" gases applies to wet or high molecular weight gases, and the other one corresponds to dry hydrocarbon gases. Standing recommends using the \\\"condensate\\\" curves in calculations that involve gases in equilibrium with crude oil condensate in petroleum reservoirs.")
add_note('Brown et al. (1948) presented the graphical correlation. Standing (1977) expressed it in a mathematical form.')
add_internal_note('The values of the development ranges are taken from the graphs presented by Standing (1977) and Ahmed (1989).')
add_internal_note("Brown et al.'s reference is not available. The correlation was verified by using these references: Standing (1977), Ahmed (1989), and Bánzer (1996). Date: September 14 2016.")
add_ref('standing:1977')
...
add_db("Based on 264 samples of natural gases with high molecular weight, rich in heptanes, with minor amounts of nitrogen and carbon dioxide, and without hydrogen sulfide. These 264 compositions were obtained from a data bank of 275 PVT reports and 634 compositions in total. The producing areas represented by this data bank are: Gulf of Mexico, Lousiana, Texas, and others.")
...
add_note("Sutton's correlation was developed based on samples of gases with no hydrogen sulfide content. The samples contained nitrogen (0 mol % to 2.86 mol %), carbon dioxide (0.01 mol % to 11.86 mol %), and heptanes-plus (0.02 mol % to 14.27 mol %).")
add_ref('sutton:1985')
add_author("Sutton")
end_correlation()
...
add_note("The correlation was developed with samples containing concentrations of nitrogen, carbon dioxide, and hydrogen sulfide, up to 12.84 mol %, 67.12 mol %, and 31.82 mol %, respectively. The samples also contained heptanes-plus in the range from 0.22 mol % to 17.2 mol %.")
