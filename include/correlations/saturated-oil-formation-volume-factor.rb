...
add_ref("standing:1947")
add_ref("beggs:1987")
add_note("Lasater didn't present a correlation for Bo. Standing's correlation is used to calculate Bob because of the similarity of his data bank and development ranges with Lasater's.")
add_internal_note("The range assigned for Rs was taken from the range expressed by the author for Rsb.")
set_hidden_calc()
end_correlation()
