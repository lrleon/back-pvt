...
begin_correlation("PbDeGhettoDetachedFromRs", "psia", 208.86, 4021.96)
...
begin_correlation("PbDeGhettoEtAl", "psia", 208.86, 4021.96)
...
begin_correlation("PbDindorukChristmanDetachedFromRs", "psia", 926, 12230)
...
begin_correlation("PbDindorukChristman", "psia", 926, 12230)
add_title("DINDORUK & CHRISTMAN CORRELATION, CALCULATION OF BUBBLE POINT PRESSURE")
add_parameter("yg", "Sgg", "Gas specific gravity", 0.623, 1.517)
add_parameter("rsb", "SCF_STB", "Solution GOR at Pb", 133, 3050)
add_parameter("api", "Api", "API oil gravity", 14.7, 40)
...
begin_correlation("PbDoklaOsman", "psia", 590, 4640)
...
begin_correlation("PbHanafyDetachedFromRs", "psia", 36, 5003)
...
begin_correlation("PbHanafy", "psia", 36, 5003)
add_title("HANAFY ET AL. CORRELATION, CALCULATION OF BUBBLE POINT PRESSURE")
add_parameter("rsb", "SCF_STB", "Solution GOR at Pb", 7, 4272)
add_db("Based on experimental PVT data of 324 fluid samples taken from 176 wells located in 75 fields. This data represents 15 productive zones of 123 reservoirs distributed along three different regions of Egypt, including the Gulf of Suez, Western Desert, and Sinai.")
add_author("Hanafy et al.")
...
begin_correlation("PbKartoatmodjoSchmidt", "psia", 14.7, 6054.7)
...
begin_correlation("PbLasater", "psia", 48, 5780)
...
begin_correlation("PbPetroskyFarshad", "psia", 1574, 6523)
...
begin_correlation("PbStanding", "psia", 130, 7000)
...
begin_correlation("PbTotalCFP", "psia")
...
begin_correlation("PbVasquezBeggs", "psia", 15, 6055)
...
begin_correlation("PbVelarde", "psia", 70, 6700)
...
begin_correlation("PbCegarra", "psia", 735, 7303)
...
begin_correlation("PbPerezML", "psia", 405, 1335)
...
begin_correlation("PbMillanArcia", "psia", 222, 3432.7)
...
begin_correlation("PbManucciRosales", "psia", 1230, 5035)
...
begin_correlation("PbGlaso", "psia", 135.304, 7112.3)
...
begin_correlation("PbLopezCR", "psia", 100, 1315)
...
begin_correlation("PbLopezCRDetachedFromRs", "psia", 100, 1315)
add_title("LÓPEZ, CASTILLO & ROJAS CORRELATION, CALCULATION OF BUBBLE POINT PRESSURE")
add_db("Based on 48 PVT tests from saturated oil reservoirs located in Bare and Arecuna fields, from the Ayacucho Area of the Faja Petrolífera del Orinoco.")
add_parameter("yg", "Sgg", "Gas specific gravity", 0.5086, 0.75)
...
begin_correlation("PbSalazar", "psia", 253, 1564)
