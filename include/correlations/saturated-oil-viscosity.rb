...
## verificada con python
begin_correlation("UobChewConnally", "CP", 0.1, 100)
...
## verificada con python
begin_correlation("UobKhan", "CP", 0.13, 77.4)
...
## verificada con python
begin_correlation("UobKartoatmodjoSchmidt",
         "CP", 0.097, 586)
...
## verificada con python
begin_correlation("UobPetroskyFarshad", "CP", 
         0.211, 7.403)
...
## verificada con python
begin_correlation("UobPerezML", "CP")
...
## verificada con python
begin_correlation("UobGilFonseca", "CP")
...
## verificada con python
begin_correlation("UobDeGhettoEtAl", "CP", 2.1, 295.9)
...
begin_correlation("UobDindorukChristman", "CP", 0.161, 8.7)
...
begin_correlation("UobLopezCR", "CP", 100, 1800)
...
begin_correlation("UobLopezCRHigherT", "CP", 100, 1125)
...
begin_correlation("UobSalazar", "CP", 109, 5040)
